...
FREE_LIMIT_DAILY = 10
UPI_ID = os.environ.get("UPI_ID", "@ig_magic")
...
<b>├⍟ 🤖 Bot Name : <a href=http://t.me/Forwardedbuddybot>Save Content</a></b>
<b>├⍟ 👨‍💻 Developer : <a href=https://t.me/ig_magic></a>◌⑅⃝●♡⋆♡𝙫𝙞𝙨𝙝𝙖𝙡♡⋆♡●⑅⃝◌</b>
...
async def send_plan(client: Client, message: Message):
    buttons = [
        [InlineKeyboardButton("📸 Send Payment Proof", url="https://t.me/ig_magic")],
